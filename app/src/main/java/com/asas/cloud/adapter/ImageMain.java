...
public class ImageMain extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final int ITEM_VIEW = 0;
    private static final int AD_VIEW = 1;
    private static final int ITEM_FEED_COUNT = 5;
    private final Activity activity;
    private final List<ImageModel> mainList;

    public ImageMain(Activity activity, List<ImageModel> mainList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM_VIEW) {
            ...
            return new ImageMain.ImageViewHolder(view);
        } else if (viewType == AD_VIEW) {
            View view = layoutInflater.inflate(R.layout.layout_ad, parent, false);
            return new ImageMain.AdViewHolder(view);
        } else {
            return null;
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder.getItemViewType() == ITEM_VIEW) {
            ...
            ((ImageMain.ImageViewHolder) holder).bindData(mainList.get(pos));
        } else if (holder.getItemViewType() == AD_VIEW) {
            ((ImageMain.AdViewHolder) holder).bindAdData();
        }
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bindData(ImageModel main) {
            //Bitmap bitmap = ImageResize.stringtobitmap(main.getThambnel());
            //img.setImageBitmap(bitmap);
            Glide.with(img.getContext()).load(main.getImage()).into(img);
            ...
            layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent =new  Intent(layout.getContext(), ShowImageActivity.class);
                    intent.putExtra("url", main.getImage());
