...
import com.asas.cloud.adapter.ContactAdapter;
import com.asas.cloud.adapter.ContactMain;
...
public class ContactsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter1 = new ContactAdapter(options);
        list = new ArrayList<>();
        list.clear();
        // = new FileMain()
        mainVideo = new ContactMain(getActivity(), list);

        References.CONTACT_Reference.child(user_id).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
